...
export default function PendingCreditsCard() {
  ...
  return <section className="rounded-xl border border-border bg-card p-4 space-y-3 text-foreground">
    ...
    <p className="text-xs text-muted-foreground">Recebidos pela plataforma, ainda não transferidos ao chaveiro. Conectar a conta não libera os créditos anteriores; o repasse automático ainda não está disponível.</p>
