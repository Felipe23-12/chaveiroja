...
export default function QueuedRequestCard({ request }) {
  ...
  return (
    <div className="p-4 rounded-xl border-2 border-warning/40 bg-warning/10 mb-4">
      ...
      <p className="text-xs text-warning mt-2">A rota começará automaticamente ao finalizar o atendimento atual.</p>
    </div>
  );
}