...
export default function LocksmithScoreCard({ score }) {
  ...
  return (
    <div className="p-4 rounded-xl border border-border bg-card flex items-center gap-3 mb-5">
      ...
      <div className="flex-1"><p className="text-sm font-semibold text-foreground">Score profissional: {value.toFixed(1)}</p><p className="text-xs text-muted-foreground">+0,5 por aceite · −1 a cada 3 recusas</p></div>
