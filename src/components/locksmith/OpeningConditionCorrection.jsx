...
export default function OpeningConditionCorrection({ request, onApplied }) {
  ...
  return <div className="rounded-2xl border-2 border-amber-300 bg-amber-50 p-4 space-y-3">
    <div className="flex gap-2 text-amber-800"><AlertTriangle className="w-5 h-5 shrink-0" /><div><p className="font-semibold text-sm">Informação diferente no local?</p><p className="text-xs mt-1">Marque o que encontrou. Para alterar o chamado, as fotos são obrigatórias.</p></div></div>
