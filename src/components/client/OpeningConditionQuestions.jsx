...
export default function OpeningConditionQuestions({ reason, onReasonChange, brokenKey, onBrokenKeyChange }) {
  return <div className="space-y-4 rounded-2xl border border-border bg-card p-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
      {[{ id: "lost_key", label: "Perdi a chave" }, { id: "lock_problem", label: "A fechadura está com problema" }].map((item) => (
    ...
    <BrokenKeySelector value={brokenKey} onChange={onBrokenKeyChange} />
  </div>;
}