...
export default function AdminPanelTabs({ value, onChange }) {
  return <div className="sticky top-0 z-30 -mx-4 overflow-x-auto border-y border-border bg-background/95 px-4 py-2 backdrop-blur md:rounded-xl md:border md:top-0">
