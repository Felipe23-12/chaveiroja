...
export default function VehicleFipeRatesEditor({ rules, disabled, onChange }) {
  return <fieldset disabled={disabled} className="rounded-xl border border-border bg-card p-4 space-y-4">
    ...
    <p className="text-sm text-muted-foreground">Escolha o veículo e informe seu percentual de mão de obra. Exemplo: Onix 2020 pode ter um percentual diferente de Tracker 2020. A regra vale do ano inicial ao final, inclusive; Onix e Onix Plus são regras separadas.</p>
